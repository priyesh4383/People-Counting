...
2. Added a function to send email alert when the number of persons exceeded a certain threshold with attached imag
"""
...
# when user checks the email checkbox, this variable will be set to True
...
email_sender ='email_1'
email_recipient = 'email_2'
